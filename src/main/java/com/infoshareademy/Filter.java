...
public class Filter {
    ...
    public static List<Drink> filterByType(List<Drink> drinks, Type type) {
        return drinks.stream()
                .filter(drink -> drink.getDrinkType() == type)
                .collect(Collectors.toList());
    }

    public static List<Drink> filterByGlassType(List<Drink> drinks, GlassType glassType) {
        return drinks.stream()
                .filter(drink -> drink.getGlassType() == glassType)
                .collect(Collectors.toList());
    }

    public static List<Drink> filterByCategory(List<Drink> drinks, Category category) {
        return drinks.stream()
